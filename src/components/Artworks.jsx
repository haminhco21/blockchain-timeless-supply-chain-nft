...
const Card = ({ nft }) => (
  <div className="w-full shadow-xl shadow-black rounded-md overflow-hidden bg-gray-800 my-2 p-3">
    ...
    <p className="text-gray-400 text-sm my-1">
      Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil quod quia
      veritatis, ratione natus vero, tempora optio voluptatibus nostrum eius
      neque asperiores et beatae sapiente? Harum quae expedita eos saepe?
    </p>
